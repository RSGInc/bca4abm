...
@orca.step()
def person_trips_processor(bca_trips_with_demographics, person_trips_spec, settings):
    ...
    bca_trips_with_demographics = bca_trips_with_demographics.to_frame()
    ...
    results = bca.assign_variables(assignment_expressions=person_trips_spec,
                                   df=bca_trips_with_demographics,
                                   locals_d=locals_d)
    ...
    add_assigned_columns("bca_trips", results)
